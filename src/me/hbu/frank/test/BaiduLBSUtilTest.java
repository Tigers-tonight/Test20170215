...
import me.hbu.frank.util.BaiduLBSUtil;

public class BaiduLBSUtilTest {

	private static String ak = "mc9ooYprKkEfVmnQxIsf13ymeZVVzEIw";
	private static String geotable_id = "160883";//house
	...
	public void getCoordinate(){
		...
		//params.put("pois", "1");//非必须
		params.put("ak", ak);
		System.out.println(baiduLBSUtil.getCoordinate(params));
	}
}
